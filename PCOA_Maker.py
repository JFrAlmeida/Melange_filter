...
from MF_statistics import SIMPER_func as smp
...
#paths
path_to_groupfile = os.path.normpath(os.path.join(path_main_melange, "Melange_extra/MF_statistics/PCOA_group.csv"))
    ...
    if counts_files_identifier in file:
        ...
        if use_my_colormap:
            color_map_dict = {
                ...
                "agarilytica/agarivorans" : "#3e4c9e",
                "sp. L2 Bin Bin 90_1": "#ff9047",
                "addita/latercula": "#ff9ad4",
                "spongiae/mytili": "#6a7500",
                "algicola/megaterium": "#ff3f65",
                "unknown":"#000000"
            }
        ...
        #categories is a df with categories as index and no columns, stupid but works, so whatever
        categories = df_pcoa["Groups"].astype("category").cat.categories
